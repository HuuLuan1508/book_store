      ...
      <div className="container mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {myBooks.map((book) => (
              <div key={book.id} className="border rounded-lg shadow-md hover:shadow-lg transition-shadow">
                <img
                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <button onClick={() => updateProgress(book.id, book.progress + 10)} className="text-blue-500 hover:text-blue-600">
                      Continue Reading
                    </button>
                    <button onClick={() => deleteBook(book.id)} className="text-red-500 hover:text-red-600">
